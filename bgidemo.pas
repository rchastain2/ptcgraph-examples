...
var
  GraphDriver : smallint; { The Graphics device driver }
  GraphMode   : smallint; { The Graphics mode value }
...
begin
  ...
  repeat
    GraphDriver := d8bit;
    GraphMode := m800x600;
    WindowTitle := 'BGI Demo for Free Pascal';
