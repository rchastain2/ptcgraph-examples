...
begin
  ...
  begin
    PlusPress := False;
    Bar(100, 50, GetMaxX - 20, 50 + TextHeight('X'));
    DoStringStuff;
    SetColor(Red);
    SetTextJustify(2, 1);
    for G := -5 to 5 do
...
begin
  ...
  SetFillStyle(1, Black);
  Bar(20, 49, GetMaxX - 19, 170);
  Rectangle(20, 49, GetMaxX - 19, 170);
  SetLineStyle(0, 0, 3);
  SetColor(White);
  Line(18, 173, GetMaxX - 16, 173);
  Line(GetMaxX - 16, 173, GetMaxX - 16, 47);
  SetColor(DarkGray);
  Line(18, 47, GetMaxX - 16, 47);
  Line(18, 47, 18, 173);
  TillPress := False;
  SetTextJustify(0, 1);
  SetTextStyle(2, 0, 10);
